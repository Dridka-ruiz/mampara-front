...
import { fetchEtiquetas54_7 } from "../../../api/extrusores/apiExt54_7";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT54-VII")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas54_7();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT54_VII).toFixed(3)
            : null;

          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT54_VII).toFixed(3)
            : null;

          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT54_VII : null,
        ...
        const setUpDatafetchTime54_7 = await fetchTime54_7();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime54_7)
          ? setUpDatafetchTime54_7
          : setUpDatafetchTime54_7.data;
        ...
        const setUpEXT54I = setUpArray.find(
          (setup) => setup.maquina === "EXT54-VII"
        );

        console.log("SetUp for EXT54-VII:", setUpEXT54I);
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt54_7/${id}`, {
                          method: "PUT",
                          headers: {
