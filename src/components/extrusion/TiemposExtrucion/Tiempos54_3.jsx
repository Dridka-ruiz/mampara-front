...
import { fetchEtiquetas54_3 } from "../../../api/extrusores/apiExt54_3";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT54-III")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas54_3();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT54_III).toFixed(3)
            : null;

          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT54_III).toFixed(3)
            : null;
          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT54_III : null,
        ...
        const setUpDatafetchTime54_3 = await fetchTime54_3();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime54_3)
          ? setUpDatafetchTime54_3
          : setUpDatafetchTime54_3.data;
        ...
        const setUpEXT54II = setUpArray.find(
          (setup) => setup.maquina === "EXT54-III"
        );

        console.log("SetUp for EXT54-III:", setUpEXT54II);
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt54_3/${id}`, {
                          method: "PUT",
                          headers: {
