...
import { fetchEtiquetas70_1 } from "../../../api/extrusores/apiExt70_1";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT70-I")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas70_1();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT70_I).toFixed(3)
            : null;

          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT70_I).toFixed(3)
            : null;

          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT70_I : null,
        ...
        const setUpDatafetchTime70_1 = await fetchTime70_1();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime70_1)
          ? setUpDatafetchTime70_1
          : setUpDatafetchTime70_1.data;
        ...
        const setUpEXT54II = setUpArray.find(
          (setup) => setup.maquina === "EXT70-I"
        );

        console.log("SetUp for EXT70-I:", setUpEXT54II);
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt70_1/${id}`, {
                          method: "PUT",
                          headers: {
