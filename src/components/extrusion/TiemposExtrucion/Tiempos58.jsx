...
import { fetchEtiquetas58 } from "../../../api/extrusores/apiExt58";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT-58")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas58();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT_58).toFixed(3)
            : null;

          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT_58).toFixed(3)
            : null;

          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT_58 : null,
        ...
        const setUpDatafetchTime58 = await fetchTime58();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime58)
          ? setUpDatafetchTime58
          : setUpDatafetchTime58.data;
        ...
        const setUpEXT54I = setUpArray.find(
          (setup) => setup.maquina === "EXT-58"
        );

        console.log("SetUp for EXT-58:", setUpEXT54I);
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt58/${id}`, {
                          method: "PUT",
                          headers: {
