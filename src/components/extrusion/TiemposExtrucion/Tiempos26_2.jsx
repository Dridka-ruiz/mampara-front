...
import { fetchEtiquetas26_2 } from "../../../api/extrusores/apiExt26_2";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT-26-II")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas26_2();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT_26_II).toFixed(3)
            : null;

          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT_26_II).toFixed(3)
            : null;

          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT_26_II : null,
        ...
        const setUpDatafetchTime26_2 = await fetchTime26_2();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime26_2)
          ? setUpDatafetchTime26_2
          : setUpDatafetchTime26_2.data;
        ...
        const setUpEXT54I = setUpArray.find(
          (setup) => setup.maquina === "EXT-26-II"
        );

        console.log("SetUp for EXT-26-II:", setUpEXT54I);
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt26_2/${id}`, {
                          method: "PUT",
                          headers: {
