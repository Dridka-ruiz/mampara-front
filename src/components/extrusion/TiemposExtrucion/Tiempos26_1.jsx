...
import { fetchEtiquetas26_1 } from "../../../api/extrusores/apiExt26_1";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT-26-I")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas26_1();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT_26_I).toFixed(3)
            : null;

          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT_26_I).toFixed(3)
            : null;

          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT_26_I : null,
        ...
        const setUpDatafetchTime26_1 = await fetchTime26_1();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime26_1)
          ? setUpDatafetchTime26_1
          : setUpDatafetchTime26_1.data;
        ...
        const setUpEXT54I = setUpArray.find(
          (setup) => setup.maquina === "EXT-26-I"
        );

        console.log("SetUp for EXT-26-I:", setUpEXT54I);
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt26_1/${id}`, {
                          method: "PUT",
                          headers: {
