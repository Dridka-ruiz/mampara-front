...
import { fetchEtiquetas54_4 } from "../../../api/extrusores/apiExt54_4";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT54-IV")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas54_4();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT54_IV).toFixed(3)
            : null;

          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT54_IV).toFixed(3)
            : null;

          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT54_IV : null,
        ...
        const setUpDatafetchTime54_4 = await fetchTime54_4();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime54_4)
          ? setUpDatafetchTime54_4
          : setUpDatafetchTime54_4.data;
        ...
        const setUpEXT54I = setUpArray.find(
          (setup) => setup.maquina === "EXT54-IV"
        );

        console.log("SetUp for EXT54-IV:", setUpEXT54I);
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt54_4/${id}`, {
                          method: "PUT",
                          headers: {
