...
import { fetchEtiquetas54_5 } from "../../../api/extrusores/apiExt54_5";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT54-V")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas54_5();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT54_V).toFixed(3)
            : null;

          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT54_V).toFixed(3)
            : null;

          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT54_V : null,
        ...
        const setUpDatafetchTime54_5 = await fetchTime54_5();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime54_5)
          ? setUpDatafetchTime54_5
          : setUpDatafetchTime54_5.data;
        ...
        const setUpEXT54I = setUpArray.find(
          (setup) => setup.maquina === "EXT54-V"
        );

        console.log("SetUp for EXT54-V:", setUpEXT54I);
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt54_5/${id}`, {
                          method: "PUT",
                          headers: {
