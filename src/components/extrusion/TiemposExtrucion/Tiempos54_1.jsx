...
import { fetchEtiquetas54_1 } from "../../../api/extrusores/apiExt54_1";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT54-I")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas54_1();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT54_I).toFixed(3)
            : null;
          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT54_I).toFixed(3)
            : null;
          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT54_I : null,
        ...
        const setUpDatafetchTime54_1 = await fetchTime54_1();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime54_1)
          ? setUpDatafetchTime54_1
          : setUpDatafetchTime54_1.data;
        ...
        const setUpEXT54I = setUpArray.find(
          (setup) => setup.maquina === "EXT54-I"
        );

        console.log("SetUp for EXT54-I:", setUpEXT54I);
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt54_1/${id}`, {
                          method: "PUT",
                          headers: {
