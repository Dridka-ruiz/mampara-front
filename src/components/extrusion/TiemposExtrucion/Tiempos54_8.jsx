...
import { fetchEtiquetas54_8 } from "../../../api/extrusores/apiExt54_8";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT54-VIII")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas54_8();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT54_VIII).toFixed(3)
            : null;

          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT54_VIII).toFixed(3)
            : null;

          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT54_VIII : null,
        ...
        const setUpDatafetchTime54_8 = await fetchTime54_8();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime54_8)
          ? setUpDatafetchTime54_8
          : setUpDatafetchTime54_8.data;
        ...
        const setUpEXT54I = setUpArray.find(
          (setup) => setup.maquina === "EXT54-VIII"
        );
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt54_8/${id}`, {
                          method: "PUT",
                          headers: {
