...
import { fetchEtiquetas54_6 } from "../../../api/extrusores/apiExt54_6";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT54-VI")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas54_6();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT54_VI).toFixed(3)
            : null;

          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT54_VI).toFixed(3)
            : null;

          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT54_VI : null,
        ...
        const setUpDatafetchTime54_6 = await fetchTime54_6();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime54_6)
          ? setUpDatafetchTime54_6
          : setUpDatafetchTime54_6.data;
        ...
        const setUpEXT54I = setUpArray.find(
          (setup) => setup.maquina === "EXT54-VI"
        );

        console.log("SetUp for EXT54-VI:", setUpEXT54I);
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt54_6/${id}`, {
                          method: "PUT",
                          headers: {
