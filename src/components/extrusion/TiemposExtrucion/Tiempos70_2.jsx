...
import { fetchEtiquetas70_2 } from "../../../api/extrusores/apiExt70_2";
    ...
    async function fetchData() {
      try {
        ...
        const ultimoProductoExtruido = productosExtruidos
          .filter((producto) => producto.extrusor === "EXT70-II")
          .pop();
        ...
        const etiquetas = await fetchEtiquetas70_2();
        ...
        const mappedEtiquetas = etiquetas.map((etiqueta) => {
          ...
          const rendimientoPorHora = producto
            ? (etiqueta.kilos / producto.EXT70_II).toFixed(3)
            : null;

          const rendimientoPorHora300 = producto
            ? (300 / producto.EXT70_II).toFixed(3)
            : null;

          return {
            ...etiqueta,
            rendimiento: producto ? producto.EXT70_II : null,
        ...
        const setUpDatafetchTime70_2 = await fetchTime70_2();

        const fechasTimeArray = Array.isArray(setUpDatafetchTime70_2)
          ? setUpDatafetchTime70_2
          : setUpDatafetchTime70_2.data;
        ...
        const setUpEXT54II = setUpArray.find(
          (setup) => setup.maquina === "EXT70-II"
        );

        console.log("SetUp for EXT70-II:", setUpEXT54II);
                  ...
                  if (puntoInicio) {
                    ...
                    if (horaMaximaUltimoIntervalo) {
                      ...
                      if (index < allProducts.length - 1) {
                        ...
                        fetch(`http://localhost:3000/etiquetasExt70_2/${id}`, {
                          method: "PUT",
                          headers: {
