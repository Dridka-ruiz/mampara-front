...
const EtiquetaTable26_2 = ({ etiquetas26_2, setEtiquetas26_2 }) => {
    ...
    const cargarEtiquetasDesdeApi = async () => {
      try {
        const [etiquetasResponse, productosResponse] = await Promise.all([
          axios.get(apiUrlEtiquetasExt26_2),
          fetchProductos(),
        ]);

        setEtiquetas26_2(etiquetasResponse.data);
  ...
  useEffect(() => {
    if (nuevaEtiquetaAgregada) {
      guardarEtiquetas(etiquetas26_2);
      setNuevaEtiquetaAgregada(false);
      console.log("etiquetas guardadas 26 2", etiquetas26_2);
    }
  }, [etiquetas26_2, nuevaEtiquetaAgregada]);
